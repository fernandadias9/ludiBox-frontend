...
isFieldInvalid(fieldName: string): boolean {
  const field = this.senhaForm.get(fieldName);
  return (field?.invalid && (field?.dirty || field?.touched || this.formSubmitted)) || false;
}
...
this.senhaForm.markAsPristine(); 
this.senhaForm.markAsUntouched(); 
